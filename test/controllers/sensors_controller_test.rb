...
class SensorsControllerTest < ActionController::TestCase
  ...
  test "should create sensor" do
    assert_difference('Sensor.count') do
      post :create, sensor: { frequency: @sensor.frequency, modulation_id: @sensor.modulation_id, name: @sensor.name, room_id: @sensor.room_id }
    end
  ...
  test "should update sensor" do
    patch :update, id: @sensor, sensor: { frequency: @sensor.frequency, modulation_id: @sensor.modulation_id, name: @sensor.name, room_id: @sensor.room_id }
    assert_redirected_to sensor_path(assigns(:sensor))
  end
